...
@router.message(F.text == LEXICON['btn_show_birthdays'])  # Ловим текст кнопки
async def show_birthdays_handler(message: Message):
    await message.answer("Список дней рождения...")
