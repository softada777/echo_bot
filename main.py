...
# Клавиатура с кнопками (видна всегда)
main_menu_kb = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text=LEXICON['btn_add_birthday'])],
        [KeyboardButton(text=LEXICON['btn_show_birthdays']),
         KeyboardButton(text=LEXICON['btn_today_birthdays'])]
    ],
    resize_keyboard=True,
    one_time_keyboard=False  # Если False — клавиатура не скроется после нажатия
)
